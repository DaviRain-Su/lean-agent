...
- Anthropic Messages. Status: partial; payload/header/parser/provider dispatch, catalog-level provider headers, Anthropic-compatible Kimi Coding/MiniMax/MiniMax CN factories, and buffered SSE event reconstruction exist. OAuth/beta/live callback behavior, Vercel AI Gateway's large Anthropic-backed catalog, and mixed-API OpenCode providers remain.
