...
- Mistral Conversations. Status: partial; direct REST payload/header/parser/provider dispatch, Pi-defined option mapping, prompt-cache affinity behavior, and buffered SSE event reconstruction exist. SDK abort/live callback behavior and SDK request-option object semantics remain.
