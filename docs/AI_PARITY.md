...
| `src/compat.ts` | `LeanAgent.AI.Compat` | partial | Global registry, simple dispatch, legacy alias support, faux provider registration/unregistration, and built-in Bedrock Converse Stream registration exist. Full legacy surface, static catalog passthroughs, image exports, and richer typed full-stream public exports are still missing. |
