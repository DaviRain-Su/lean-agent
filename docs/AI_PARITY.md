...
- Azure OpenAI Responses. Status: partial; Responses transport, Azure URL/deployment resolution, provider factory, auth, current Pi model catalog, and tests exist; SDK abort/dynamic catalog behavior remains.
